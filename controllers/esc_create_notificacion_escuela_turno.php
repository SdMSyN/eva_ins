<?php
    ...
    $turn = $_POST['inputAvTurn'];
    //echo $idEsc.'--'.$aviso.'--'.$avisoTipo.'--'.$avisoDest;
    
    $msgErr = '';
    $ban = true;
    $arrNot = array();
    // Buscamos alumnos que pertenezcan a la escuela y creamos aviso
    // Buscamos a sus tutores y creamos aviso
