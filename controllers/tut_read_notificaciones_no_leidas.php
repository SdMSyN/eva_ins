<?php
    ...
    $sqlGetAvInfo = "SELECT $tAvAsigT.id as id, $tAvAsigT.enterado as enterado, $tAvInfo.nombre, "
            . "$tAvTipo.nombre as tipo, $tAvInfo.dirigido_a, "
            ...
            . "WHERE $tAvAsigT.tutor_id='$idTut' AND $tAvAsigT.enterado IS NULL "
            . "ORDER BY creado ";
    //Ordenar ASC y DESC
