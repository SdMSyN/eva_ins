...
?>
    ...
    <div class="container">
        ...
        <div class="row text-center"><h1>Personal de apoyo</h1></div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">Añadir nueva secretaria</h4>
                        <p class="msgModal"></p>
                    </div>
        ...
        $(document).ready(function(){
           ...
           function filtrar(){
               $.ajax({
                   type: "POST",
                   data: ordenar, 
                   url: "../controllers/esc_get_secretarias.php?idEsc="+<?=$idUser;?>,
           ...
           $("#data").on("click", "#delete", function(){
                var idSec = $(this).val();
                //alert("Hola: "+idProf);
                if(confirm("¿Seguro que deseas eliminar a esta secretaria?")){
                    $('#loading').show();
                    $.ajax({
                         method: "POST",
                         url: "../controllers/delete_secretaria.php?idSec="+idSec,
                         success: function(data){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'esc_read_secretarias.php';
                                }, 1500);
                            }else{
                                $('#loading').empty();
           ...
           $('#formSignUp').validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "../controllers/esc_create_usuario_secretaria.php", 
