...
?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                type: "POST",
                url: "../controllers/tut_read_notificaciones_leidas.php?idTut="+<?=$idUser;?>,
                success: function(msg){
                    console.log(msg);
                    var msg = jQuery.parseJSON(msg);
                    if(msg.error == 0){
            ...
            $("#dataNotPorLeer").on("click", "#marcarLeido", function(){
                ...
                if(confirm("¿Seguro que ya haz leído la información?")){
                    ...
                    $.ajax({
                         method: "POST",
                         url: "../controllers/tut_update_notificacion_vista.php?idAv="+idAv,
                         success: function(data){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'tut_read_notificaciones.php';
                                }, 1500);
                            }else{
                                $('#loading').empty();
