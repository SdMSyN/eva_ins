                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-3 text-center">
                                <a href="sec_create_notificacion_escuela.php" class="btn btn-primary">Escuela</a>
                                <p>Envía la notificación a todos los alumnos de la escuela.</p>
                            </div>
                            <div class="col-sm-3 text-center">
                                <a href="sec_create_notificacion_escuela_turno.php" class="btn btn-primary">Turnos</a>
                                <p>Envía la notificación solo a los alumnos de un turno de la escuela.</p>
                            </div>
                            <div class="col-sm-3 text-center">
                                <a href="sec_create_notificacion_grupos.php" class="btn btn-primary">Grupos</a>
        ...
        <div class="modal fade" id="modalSelGrupo" tabindex="-1" role="dialog" aria-labellebdy="myModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="sec_create_notificacion_alumnos.php" class="form-horizontal">
        ...
        $(document).ready(function(){
           ...
           function filtrar(){
               $.ajax({
                   type: "POST",
                   data: ordenar, 
                   url: "../controllers/esc_read_notificaciones.php?idEsc=<?=$idEsc;?>",
           ...
           $("#modalSelGrupo #inputGrado").on("change", function(){
               ...
               $.ajax({
                    type: "POST", 
                    url: "../controllers/get_grupo_by_grado.php?idGrado="+grado+"&idEsc=<?=$idEsc;?>",
                    success: function(msg){
                        console.log(msg);
                        var msg = jQuery.parseJSON(msg);
                        if(msg.error == 0){
